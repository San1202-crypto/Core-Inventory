          ...
          <GlassCard variant="amber">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              {order.status === "processing" && (
                <Button
                  variant="outline"
                  className="h-8 text-xs font-medium bg-amber-500/10 text-amber-600 dark:text-amber-400 hover:bg-amber-500/20 border-amber-500/20"
              ...
              {order.status === "picked" && (
                <Button
                  variant="outline"
                  className="h-8 text-xs font-medium bg-blue-500/10 text-blue-600 dark:text-blue-400 hover:bg-blue-500/20 border-blue-500/20"
